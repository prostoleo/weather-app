<template>
  <div class="down-part__card card p-3 bg-secondary1 relative rounded-2xl mt-3">

    <header class="card__header flex justify-center items-center gap-x-4">

      <span class="title bg-secondary2 rounded-2xl font-light text-sm text-black80 p-3 absolute top-0 left-0">CБ, 02.10</span>

      <div class="inline-flex gap-x-3 ml-3">
        <img class="w-5"  src="/icons/clouds.svg" alt="">
